...
const Index = () => {
  ...
  const content = (
    <div className="min-h-full">
      ...
      <header className="sticky top-0 z-[100] px-4 pt-4 md:px-8 md:pt-8 pb-4 pwa-safe-top bg-background/95 backdrop-blur-xl" style={{ position: 'sticky !important', top: 0, zIndex: 100 }}>
        {/* Mobile layout */}
