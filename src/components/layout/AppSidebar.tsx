...
export function AppSidebar() {
  ...
  return (
    <Sidebar className={`transition-all duration-300 ease-in-out bg-black/20 dark:bg-white/10 backdrop-blur-2xl border-r border-white/20 dark:border-white/10 supports-[backdrop-filter]:bg-black/20 supports-[backdrop-filter]:dark:bg-white/10 md:pt-12 ${state === "collapsed" ? "w-0 opacity-0 pointer-events-none -translate-x-full" : "w-64 md:w-72"}`} collapsible="offcanvas">
