...
-- Drop and recreate the add_share_with_user_link function to handle usernames
DROP FUNCTION IF EXISTS public.add_share_with_user_link(uuid,uuid,text,text);
