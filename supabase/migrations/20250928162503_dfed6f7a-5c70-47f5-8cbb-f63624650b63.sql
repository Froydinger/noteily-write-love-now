-- Fix the get_shared_note_display_info function to properly display shared user information
...
BEGIN
  ...
  -- Return sanitized information with corrected logic
  RETURN QUERY
  SELECT 
    sn.id,
    sn.note_id,
    CASE 
      ...
      WHEN sn.shared_with_username IS NOT NULL 
